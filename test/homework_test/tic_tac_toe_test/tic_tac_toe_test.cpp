...
TEST_CASE("Test game over if 9 slots are selected4") {
	unique_ptr<TicTacToe> game = make_unique<TicTacToe4>();
	game->start_game("X");
	game->mark_board(1);
	game->mark_board(2);
...
///////////// Test Diagonal Wins //////////////////////
TEST_CASE("Test win from top right4") {
	unique_ptr<TicTacToe> game = make_unique<TicTacToe4>();
	REQUIRE(game->game_over() == false);
	game->start_game("X");
	game->mark_board(4);
...
TEST_CASE("Test win from top left4") {
	unique_ptr<TicTacToe> game = make_unique<TicTacToe4>();
	REQUIRE(game->game_over() == false);
	game->start_game("X");
	game->mark_board(1);
